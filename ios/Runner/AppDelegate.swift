...
@objc class AppDelegate: FlutterAppDelegate {
  override func application(
    ...
    let METHOD_CHANNEL_NAME = "amer.beso.barometer/method"
    let PRESSURE_CHANNEL_NAME = "amer.beso.barometer/pressure"
    ...
    let pressureChannel = FlutterEventChannel(name: PRESSURE_CHANNEL_NAME, 
